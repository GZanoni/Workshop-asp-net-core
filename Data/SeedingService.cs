...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Luiza Theobald", "lutheobald@gmail.com", new DateTime(1995, 7, 6), 2000.0, d3);
            Seller s2 = new Seller(2, "Natalia Zanoni", "naty.zanoni@gmail.com", new DateTime(1998, 3, 21), 2000.0, d4);
            Seller s3 = new Seller(3, "Vanilza Zanoni", "vanilza@yahoo.com.br", new DateTime(1971, 11, 11), 3000.0, d3);
            Seller s4 = new Seller(4, "Gilson Zanoni", "gilson@yahoo.com.br", new DateTime(1967, 3, 13), 3000.0, d1);
            Seller s5 = new Seller(5, "Cleverson Santos", "cls@gmail.com", new DateTime(1992, 4, 30), 2000.0, d2);
            Seller s6 = new Seller(6, "Claudemir Santos", "claudemir@gmail.com", new DateTime(1985, 4, 19), 2500.0, d1);
